...
function CheckoutPage() {
  ...
  const handlePlaceOrder = () => {
    ...
    if (!user) {
      toast.error("Please login to place order", { position: "top-right" });
      return;
    }
    ...
    toast.success("Order placed successfully!", {
      ...
      onClose: () => {
        ...
        // localStorage.removeItem("cart"); or dispatch(clearCart());
        window.location.href = "/myorder"; // redirect to My Orders page
      },
    });
  };
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">
                    ₹{product.product_price} x {product.quantity}
                  </p>
                </div>
