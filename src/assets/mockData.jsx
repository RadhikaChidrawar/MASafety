...
const  sampleData = [
    ...
    {
      product_id: 10,
      product_name: "Fire Extinguisher (ABC)",
      product_Description: "Multi-purpose fire extinguisher for construction sites.",
      product_price: 2200,
      product_star: 4.6,
      delivery_time: "3-5 Days",
      product_image: prod10,
    },
    {
      product_id: 11,
      product_name: "Fire Blanket",
      product_Description: "Fire-resistant blanket for emergency use.",
      product_price: 900,
      product_star: 4.3,
      delivery_time: "2-4 Days",
      product_image: prod11,
    },
    {
      product_id: 12,
      product_name: "Fire Alarm & Smoke Detector",
      product_Description: "Early warning fire alarm system for safety.",
      product_price: 2800,
      product_star: 4.7,
      delivery_time: "4-7 Days",
      product_image: prod12,
    },
    {
      product_id: 13,
    ...
    },
    {
      ...
      product_Description: "Handheld voltage tester for electrical work.",
      product_price: 1200,
      product_star: 4.4,
      delivery_time: "2-5 Days",
